...
{
	/**
	 * Encodes the given {@code int} value using big-endian byte ordering
	 * convention.
	 *
	...
	/**
	 * Encodes the given {@code long} value using big-endian byte ordering
	 * convention.
	 *
	...
	{
		out[off] = (byte) (n >>> 56 & 0xFF);
		out[off + 1] = (byte) (n >>> 48 & 0xFF);
		out[off + 2] = (byte) (n >>> 40 & 0xFF);
		out[off + 3] = (byte) (n >>> 32 & 0xFF);
		out[off + 4] = (byte) (n >>> 24 & 0xFF);
		out[off + 5] = (byte) (n >>> 16 & 0xFF);
		out[off + 6] = (byte) (n >>> 8 & 0xFF);
		out[off + 7] = (byte) (n & 0xFF);
	}

	/**
	 * Decodes the first 4 bytes of the given array into an {@code int}
	 * value using big-endian byte ordering convention.
	 *
	 ...
	 * into an {@code int} value using big-endian byte ordering convention.
	 *
	 * @param in the encoded value.
	 ...
	 * into a {@code long} value using big-endian byte ordering convention.
	 *
	 * @param in the encoded value.
	 * @param off the input offset.
	 *
